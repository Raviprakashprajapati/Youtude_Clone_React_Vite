...
function Gaming() {
  ...
  function fetchData(inputData, next = null) {
    ...
    const url = next
      ? `https://youtube138.p.rapidapi.com/search/?q=marvel&cursor=${nextUrl}&hl=en&gl=US`
    ...
    fetch(url, options)
      ...
      .then((value) => {
        ...
        console.log("gaming result - ", value);
  ...
  return (
    <>
      <div>
        <h3 className="text-center">Marvel </h3>
      </div>
